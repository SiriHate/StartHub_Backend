...
public class GlobalExceptionHandler {
  ...
  @ExceptionHandler
  public ResponseEntity<ErrorResponse> handleNoSuchConfirmationTokenException(
      NoSuchConfirmationTokenException e) {
    ErrorResponse errorResponse = new ErrorResponse(e.getMessage());
    LOGGER.error(e.getMessage());
    return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
  }
  ...
  @ExceptionHandler
  public ResponseEntity<ErrorResponse> handleMismatchedPasswordException(
      MismatchedPasswordException e) {
    ErrorResponse errorResponse = new ErrorResponse(e.getMessage());
    LOGGER.error(e.getMessage());
    return new ResponseEntity<>(errorResponse, HttpStatus.UNAUTHORIZED);
  }
