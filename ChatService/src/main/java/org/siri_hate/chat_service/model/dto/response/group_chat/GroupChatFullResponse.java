...
/**
 * This class represents a full response for a group chat.
 * It contains the chat's id, title, type, list of participants, number of participants, list of messages, and the chat owner.
 */
public class GroupChatFullResponse {
    ...
    /**
     * Default constructor for the GroupChatFullResponse class.
     */
    public GroupChatFullResponse() { }

    /**
     * Constructor for the GroupChatFullResponse class.
     * It initializes the id, title, type, list of participants, number of participants, list of messages, and the chat owner.
     *
