...
public class ArticleCategoryController {
    ...
    public ResponseEntity<List<ArticleCategorySummaryResponse>> getAllArticleCategory() {
        List<ArticleCategorySummaryResponse> articleCategories =
                articleCategoryService.getAllArticleCategory();
    ...
    public ResponseEntity<String> updateArticleCategory(
            @Positive @PathVariable Long id, @RequestBody ArticleCategoryRequest request) {
    ...
    public ResponseEntity<String> deleteArticleCategory(@Positive @PathVariable Long id) {
        ...
        return new ResponseEntity<>(
                "Article category was successfully deleted!", HttpStatus.NO_CONTENT);
    }
}
